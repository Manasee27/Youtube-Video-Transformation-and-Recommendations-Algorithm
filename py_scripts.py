...
import moviepy.editor as mp # To crop videospip install --upgrade <library_name>
...
if sys.argv[1] == 'generate_tags':
    generate_tags()
elif sys.argv[1] == 'generate_titles':
    gen_titles_all(sys.argv[2], sys.argv[4], sys.argv[3])
elif sys.argv[1] == 'shorten_video':
